...
const controlBookDetail = async function() {
    try {
        ...
        // render html
        _detailViewJsDefault.default.render(_modelJs.state.book);
    } catch (err) {
        console.log(err);
    }
};
...
const loadSearchResults = async function(query, page = 1) {
    ...
    try {
        ...
        const data = await _helpers.getJSON(`${_config.API_URL}?target=title`, query, state.search.page);
...
parcelHelpers.export(exports, "BOOK_PER_PAGE", ()=>BOOK_PER_PAGE
);
...
const getJSON = async function(url, query, page) {
    try {
        const axiosPro = await _axiosDefault.default(url, {
            method: 'GET',
            params: {
                query: query,
                page: page,
                size: _config.BOOK_PER_PAGE
            },
            headers: {
                Authorization: `KakaoAK ${_config.API_KEY}`
            }
        });
...
},{"axios":"1IeuP","./config":"6V52N","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1IeuP":[function(require,module,exports) {
