    ...
    return (function(e) {
        ...
        function(e3, t, n) {
            ...
            var u, c = {
                ...
                transformRequest: [
                    function(e2, t) {
                        return o(t, "Accept"), o(t, "Content-Type"), r.isFormData(e2) || r.isArrayBuffer(e2) || r.isBuffer(e2) || r.isStream(e2) || r.isFile(e2) || r.isBlob(e2) ? e2 : r.isArrayBufferView(e2) ? e2.buffer : r.isURLSearchParams(e2) ? (a(t, "application/x-www-form-urlencoded;charset=utf-8"), e2.toString()) : r.isObject(e2) || t && "application/json" === t["Content-Type"] ? (a(t, "application/json"), (function(e, t, n) {
                            if (r.isString(e)) try {
                ...
                transformResponse: [
                    function(e) {
                        var t = this.transitional || c.transitional, n = t && t.silentJSONParsing, o = t && t.forcedJSONParsing, s = !n && "json" === this.responseType;
                        if (s || o && r.isString(e) && e.length) try {
                            return JSON.parse(e);
                        } catch (e1) {
                            if (s) {
                                if ("SyntaxError" === e1.name) throw i(e1, this, "E_JSON_PARSE");
                                throw e1;
                            }
                        }
                        return e;
            ...
            e.exports = function(e) {
                return new Promise(function(t, n) {
                    ...
                    if (g.open(e.method.toUpperCase(), s(w, e.params, e.paramsSerializer), !0), g.timeout = e.timeout, "onloadend" in g ? g.onloadend = E : g.onreadystatechange = function() {
                        ...
                        var t = e.timeout ? "timeout of " + e.timeout + "ms exceeded" : "timeout exceeded", r = e.transitional || l.transitional;
        ...
        function(e, t, n) {
            ...
            e.exports = function(e) {
                return u(e), e.headers = e.headers || {
                }, e.data = o.call(e, e.data, e.headers, e.transformRequest), e.headers = r.merge(e.headers.common || {
                }, e.headers[e.method] || {
                }, e.headers), r.forEach([
                    "delete",
                    "get",
...
//# sourceMappingURL=index.b8546c30.js.map
